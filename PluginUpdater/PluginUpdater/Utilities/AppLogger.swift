...
/// Log files are stored at ~/Library/Logs/PluginUpdater/ and kept for 7 days.
final class AppLogger {
    ...
    let logsDirectoryURL: URL = {
        ...
        return base.appendingPathComponent("Logs/PluginUpdater", isDirectory: true)
    }()
    ...
    private func openFileForToday() {
        ...
        let fileURL = logsDirectoryURL.appendingPathComponent("plugin-updater-\(dateString).log")
        let fm = FileManager.default
